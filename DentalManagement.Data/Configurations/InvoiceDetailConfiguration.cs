...
namespace DentalManagement.Data.Configurations
{
    class InvoiceDetailConfiguration : IEntityTypeConfiguration<InvoiceDetail>
    {
        public void Configure(EntityTypeBuilder<InvoiceDetail> builder)
        {
            ...
            builder.Property(x => x.ItemAmount).HasMaxLength(100);
            builder.Property(x => x.ItemDiscountAmount).HasMaxLength(100);
            builder.Property(x => x.ItemDiscountPercent).HasMaxLength(100);
